...
export const metadata: Metadata = {
  title: "Used Phones Under Rs 50000 in Pakistan",
  description: "Browse used mobile phones under Rs 50000 in Pakistan from real seller listings.",
  alternates: { canonical: absoluteUrl("/used-mobile-phones/under-50000") },
};
...
export default async function PageComponent() {
  ...
  return (
    <Page>
      <PageTitle kicker="Budget phones" title="Used Phones Under Rs 50000 in Pakistan" description="Current seller listings at or below Rs 50000. Compare condition, storage, PTA status and location." />
      {models.length ? (
        <section className="mb-7 rounded-lg border border-line bg-surface p-4 sm:p-5">
          <h2 className="text-base font-semibold">Popular models with live inventory under Rs 50000</h2>
      ...
      {result.rows.length ? (
        ...
        <EmptyState title="No listings under Rs 50000 yet" body="Browse all used phones or check back as sellers add inventory." actionHref="/used-mobile-phones" actionLabel="Browse used phones" />
      )}
    </Page>
  );
}
