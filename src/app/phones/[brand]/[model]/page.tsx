      ...
      <section className="mb-7 grid gap-6 lg:grid-cols-2">
        <div className="rounded-lg border border-line bg-surface p-5">
          ...
          <div className="mt-4 grid grid-cols-2 gap-2 text-sm">
            <div className="rounded-md border border-line bg-white p-3"><p className="text-muted">Listings</p><p className="mt-1 font-semibold text-ink">{result.total}</p></div>
            <div className="rounded-md border border-line bg-white p-3"><p className="text-muted">Cities</p><p className="mt-1 font-semibold text-ink">{cities.length || "—"}</p></div>
          </div>
        </div>
        <div className="rounded-lg border border-line p-5">
          ...
          <div className="mt-4 flex flex-wrap gap-3 text-sm">
            ...
            <Link href="/guides/buy-used-phone" className="link">Used-phone buying guide</Link>
          </div>
        </div>
      </section>
